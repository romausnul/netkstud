 ...
 */
 ...
 if(isset($_GET['active']) and $_GET['active'] == 'ok')
	echo '<b>Ваш аккаунт на НЭТК БЛОКЕР успешно активирован!</b>';
 ...
 if(isset($_GET['key']))
 {
	...
	else
	{
		...
		$title = 'Ваш аккаунт на НЭТК БЛОКЕР успешно активирован';
		$message = 'Поздравляю Вас, Ваш аккаунт на НЭТК БЛОКЕР успешно активирован';
